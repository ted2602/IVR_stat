...
echo '<h2 id="title">'._('IVR statistics settings').'</h2>';
...
$table->add_row('<a href="javascript:void(null)" class="info">Log IVR Selections <span style="left: -18px; display: none; ">' . _('When checked, IVR selections will be reported by IvrStats') . '</span></a>', '<input type="checkbox" name="ivr_logging" value="true" ' . $checked . '>');
$table->add_row('');
$table->add_row('');
